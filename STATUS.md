...
## Current phase
**Phase 3 complete.** All 6 sub-steps (3.A foundation · 3.B landings · 3.C indexes · 3.D detail pages · 3.E cross-links + JSON-LD · 3.F cleanup + QA) shipped. Per the locked sequence, Phase 4 execution kicks off next without further approval.

**Live preview:** https://hbot-resource.pages.dev (HTTPS, `noindex` during build phase). **99 routes** deployed. All editorial-integrity precedents locked. Source PDF for Phase 4 in `docs/sources/Other_HBOT_applications.pdf`.

## Next: Phase 4.A — DOI verification tooling + research workflow + 3 new dept entries.

...
const NON_DOI_HOSTS_RE =
  /^https?:\/\/(?:[\w-]+\.)*(?:ncbi\.nlm\.nih\.gov|uhms\.org|scivisionpub\.com|clinicaltrials\.gov|cms\.gov|web\.archive\.org)\b/i;
...
export function classifyDoiField(value) {
  ...
  return {
    kind: "malformed",
    reason:
      "expected bare DOI (10.XXXX/...), canonical doi.org URL, or recognised non-DOI repository URL (PubMed/PMC/NCBI Bookshelf/UHMS/scivisionpub/ClinicalTrials.gov/CMS/Wayback Machine)",
  };
}
